...
Description:
   Infers taxonomic abundance from Kraken results.  By default, each
   Kraken result file will create a separate dataset named after the file
   (see -c).
...
Input:
   ...
   kraken_output     File containing Kraken results in tabular format
